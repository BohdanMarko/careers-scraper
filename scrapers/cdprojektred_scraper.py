        ...
        try:
            ...
            try:
                ...
                if jobs_data and isinstance(jobs_data, list):
                    ...
                    print("No job data found in window.cdpData.jobsData")

            except Exception as e:
                print(f"Error extracting job data from JavaScript: {e}")

        except Exception as e:
            print(f"Error scraping CD Projekt Red careers page: {e}")
        finally:
            if driver:
                driver.quit()
